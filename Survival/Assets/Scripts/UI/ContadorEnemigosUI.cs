...
public class CounterEnemicsUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI textoTipoEnemigo;
    ...
    public void ActualizarUI()
    {
        ...
        // Actualizar texto del tipo de enemigo
        if (textoTipoEnemigo != null)
        {
            string nombreTipo = sistemaCounter.ObtenerNombreTipoEnemigo();
            textoTipoEnemigo.text = $"Tipo: {nombreTipo}";
        }
    }
}
