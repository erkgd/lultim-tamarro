...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Nueva direcci�n de movimiento que mezcla ambos ejes
        //Vector3 movementDirection = new Vector3(h + v, 0, v - h);
        Vector3 movementDirection = new (h + v, 0, v - h);      // Expressi� alternativa
        float magnitude = Mathf.Clamp01(movementDirection.magnitude);

        // Si Shift est� presionado, duplica la velocidad
